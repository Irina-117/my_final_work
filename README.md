...
```
 ...
 fir@fir_VB:\~$ cd Pitomnik2/

fir@fir_VB:\~/Pitomnik2$ cat \> Pets.txt
...
fir@fir_VB:\~/Pitomnik2$ cat \> PackAnimals.txt
...
fir@fir_VB:\~/Pitomnik2$ cat Pets.txt PackAnimals.txt \> Animals.txt

fir@fir_VB:\~/Pitomnik2$ cat Animals.txt
...
fir@fir_VB:\~/Pitomnik2$ mv Animals.txt HumanFriends.txt

fir@fir_VB:\~/Pitomnik2$ ls

HumanFriends.txt  PackAnimals.txt  Pets.txt  
fir@fir_VB:\~/Pitomnik2$ mkdir PetsDirectory

fir@fir_VB:\~/Pitomnik2$ mv HumanFriends.txt PetsDirectory/

fir@fir_VB:\~/Pitomnik2$ cd PetsDirectory/

fir@fir_VB:\~/Pitomnik2/PetsDirectory$ ls

HumanFriends.txt
```
## 3\. fir@fir_VB:\~/Pitomnik2/PetsDirectory$ sudo apt-get update
```
\[sudo\] пароль для fir:
...
fir@fir_VB:\~/Pitomnik2/PetsDirectory$ sudo apt-get intstall mysql-server

E: Неверная операция intstall

fir@fir_VB:\~/Pitomnik2/PetsDirectory$ sudo apt-get install mysql-server
...
fir@fir_VB:\~/Pitomnik2/PetsDirectory$ mysql \--version

mysql  Ver 8.0.39 for Linux on x86\_64 (MySQL Community Server \- GPL)
```
## 4\.
```
fir@fir_VB:\~/Pitomnik2/PetsDirectory$ sudo apt-get install cowsay
...
fir@fir_VB:\~/Pitomnik2/PetsDirectory$ cowsay "Приветствую\!"
...
fir@fir_VB:\~/Pitomnik2/PetsDirectory$ sudo apt-get remove cowsay
...
## 5\.  
``` 
fir@fir_VB:\~/Pitomnik2/PetsDirectory$ history \> history.txt
